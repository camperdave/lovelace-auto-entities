...
In the `options:` option of the filters, the string `this.entity_id` will be replaced with the matched entity_id, and `this.entity_attribute[attribute]` will be replaced with the value of the specified attribute of the entity. Useful for service calls - see below.
